...
def process_data(file, path):
    ...
    jsonl_save(filepath=path+file.replace('KPTimes', 'KPTimes-lr-1000'), data_dict=data_dict)
...
for seed in seeds:
    ...
    np.random.seed(seed)
    if P == 0.7: 
        dump_folder = '../../stage2_processed_data/KPTimes-lr-1000/{}/v6_kpdrop_aug/'.format(seed)
    else:
        dump_folder = '../../stage2_processed_data/KPTimes-lr-1000/{}/v6_kpdrop_aug_P{}/'.format(seed, P)
    ...
    os.rename(dump_folder+'KPTimes_metadata.pkl', dump_folder+'KPTimes-lr-1000_metadata.pkl')