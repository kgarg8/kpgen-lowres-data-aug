...
for seed in seeds:
    ...
    np.random.seed(seed)
    if P == 0.7:
        dump_folder = '../../stage2_processed_data/LDKP3km-lr-4000/{}/v2_kpdrop_aug/'.format(seed)
    else:
        dump_folder = '../../stage2_processed_data/LDKP3km-lr-4000/{}/v2_kpdrop_aug_P{}/'.format(seed, P)
