# Added code for calculating statistics; didnt merge the change in all files
# Also modified sr_helper
# See total_count and count_unchanged
...
for seed in seeds:
    random.seed(seed)
    np.random.seed(seed)
    dump_folder = '../../stage2_processed_data/LDKP3km-lr-1000/{}/v2_sr_aug_k{}/'.format(seed, K)
