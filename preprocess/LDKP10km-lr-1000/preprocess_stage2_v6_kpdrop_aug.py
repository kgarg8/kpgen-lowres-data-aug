...
# v6_kpdrop_aug - T+A followed by Body-masked
...
def process_data(file, path):
    ...
    jsonl_save(filepath=path+file.replace('LDKP10km', 'LDKP10km-lr-1000'), data_dict=data_dict)
...
for seed in seeds:
    ...
    np.random.seed(seed)
    if P == 0.7: 
        dump_folder = '../../stage2_processed_data/LDKP10km-lr-1000/{}/v6_kpdrop_aug/'.format(seed)
    else:
        dump_folder = '../../stage2_processed_data/LDKP10km-lr-1000/{}/v6_kpdrop_aug_P{}/'.format(seed, P)
    ...
    os.rename(dump_folder+'LDKP10km_metadata.pkl', dump_folder+'LDKP10km-lr-1000_metadata.pkl')