...
class GRUSeq2Seq_collater:
    ...
    def collate_fn(self, batch):
        ...
        # change added on Dec 11, when running v6_kpdrop_aug_pkp, LDKP3km-lr-2000
        MAX_SRC_LEN = 800
        srcs     = [src[:MAX_SRC_LEN] for src in srcs]
        srcs_vec = [src_vec[:MAX_SRC_LEN] for src_vec in srcs_vec]
